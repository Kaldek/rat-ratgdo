...
Note that the D1 Mini **board** takes 5v and an on-board regulator drops this down to the 3.3v power used by the ESP8266 chip.
...
![Generic ESP-32 board pinout](https://github.com/Kaldek/rat-ratgdo/blob/main/schematics/ratgdo%20open%20source%20ESP-32_schem_v3.png)
